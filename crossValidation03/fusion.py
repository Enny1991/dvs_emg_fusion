...
class fusionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return emgInput, dvsInput, desiredClass, label
...
if __name__ == '__main__':
    ...
    for epoch in range(lastEpoch, 1000):
        ...
        # Training loop.
        for i, (emgInput, dvsInput, target, label) in enumerate(trainLoader, 0):
            net.train()
        ...
        if stats.testing.bestAccuracy is True:  torch.save(net.state_dict(), 'Trained/fusionGesture.pt')
        # if stats.testing.bestAccuracy is True:  torch.save(net.module.state_dict(), 'Trained/fusionGesture.pt')
    ...
    # net.module.load_state_dict(torch.load('Trained/fusionGesture.pt'))
    genLoihiParams(net)
